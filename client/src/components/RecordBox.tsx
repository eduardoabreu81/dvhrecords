        ...
        {isOpen && (
          ...
          >
            ...
            <button
              ...
              className="absolute top-8 right-8 p-3 rounded-full bg-card/50 border border-primary/30 hover:border-primary transition-all glow-box-cyan"
            >
            ...
            <div className="relative w-full max-w-md h-[600px] flex flex-col items-center justify-center">
              ...
              >
                <div
                  className="w-80 h-80 rounded-lg overflow-hidden border-4 border-primary/50 glow-box-cyan-strong cursor-grab active:cursor-grabbing"
                  draggable
                  onDragStart={(e) => {
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background via-background/80 to-transparent p-6">
                  <h3 className="text-2xl font-display text-primary glow-cyan mb-1">
                    {currentArtist.name}
                  </h3>
