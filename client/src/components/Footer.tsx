...
export default function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-card/50 backdrop-blur-sm border-t border-primary/20 py-2 sm:py-3 md:py-4 z-50">
      <div className="container max-w-7xl mx-auto px-3 sm:px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-2 sm:gap-3 md:gap-4">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="text-foreground/70 text-xs sm:text-sm text-center md:text-left"
          >
          ...
          >
            <span className="text-foreground/50 text-xs sm:text-sm">{t('footer.followUs')}</span>
            <a
