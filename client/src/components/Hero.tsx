...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 min-h-screen flex flex-col lg:flex-row items-center justify-center px-4 sm:px-6 gap-6 lg:gap-12">
        {/* Coluna Esquerda: Tagline */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.5, duration: 0.8 }}
          className="flex-1 text-center lg:text-left max-w-full"
        >
          <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-9xl font-display text-white glow-cyan-strong mb-4 sm:mb-6 leading-tight">
            <span className="font-bold tracking-wider">GLOBAL</span>{' '}
            <span className="font-normal tracking-widest opacity-70">SOUNDS.</span>
          </h2>
          <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-display text-primary glow-cyan-strong leading-tight">
