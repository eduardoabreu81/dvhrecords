      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {mockReleases.map((release, index) => (
          <motion.div
            ...
            className="group relative bg-card/50 border border-border hover:border-primary/50 rounded-lg overflow-hidden transition-all"
          >
            <div className="flex flex-col md:flex-row gap-6 p-6">
              ...
              <div className="relative flex-shrink-0">
                <img
                  src={release.cover}
                  alt={release.title}
                  className="w-full md:w-48 h-48 rounded object-cover"
                />
                ...
                <div className="flex flex-wrap gap-3">
                  {release.spotify && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 hover:bg-primary/20 hover:border-primary rounded text-sm font-medium text-primary transition-all"
                    >
